(function ($) {
    ...
    var navPos = jQuery('.menu').offset().top;
    var navHeight = jQuery('.menu').outerHeight();
    jQuery(window).on('scroll', function () {
      if (jQuery(this).scrollTop() > navPos) {
        jQuery('body').css('padding-top', navHeight);
        jQuery('.menu').addClass('.menu_fix');
      } else {
        jQuery('body').css('padding-top', 0);
        jQuery('.menu').removeClass('.menu_fix');
      }
    });
    ...
    var navPos = jQuery('.unfix').offset().top;
    var navHeight = jQuery('.unfix').outerHeight();
    jQuery(window).on('scroll', function () {
      if (jQuery(this).scrollTop() > navPos) {
        jQuery('body').css('padding-top', navHeight);
        jQuery('.unfix').addClass('unvi');
        jQuery('.fix').addClass('vi');
      } else {
        jQuery('body').css('padding-top', 0);
        jQuery('.fix').removeClass('vi');
        jQuery('.unfix').removeClass('unvi');
      }
    });
